...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanGeovanyWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception {
    ...
    public void heFindsTheCourse(List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorInTheSpotlight().should(GivenWhenThen.seeThat(Answer.toThe(academyChoucairData.get(0).getStrCourseQuestion())));
    }
